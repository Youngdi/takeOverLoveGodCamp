  ...
  render() {
    return (
      <View
        ...
        >
          <View style={{flex:1, width:width, height:height * 0.8, justifyContent:'center', alignItems:'center', backgroundColor:'rgba(255,255,255,0)'}}>
            ...
            <View style={styles.row1}>
              <View style={{flexDirection:'row',flexWrap:'nowrap',flex:1, width:'100%'}}>
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M1.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.bible.bind(this)()}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
                    </TouchableHighlight>
                  </ImageBackground>
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M2.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                  ...
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M4.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.props.navigation.navigate({routeName:'Scan',key:'Scan',params:{getEgg:this.getEgg}})}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
                  ...
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M5.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.props.navigation.navigate({routeName:'Scan',key:'Scan',params:{getEgg:this.getEgg}})}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
            ...
            <View style={styles.row1}>
              <View style={{flexDirection:'row',flexWrap:'nowrap',flex:1, width:'100%'}}>
                  ...
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M8.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => {}}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
            ...
            <View style={styles.row1}>
              <View style={{flexDirection:'row',flexWrap:'nowrap',flex:1, width:'100%'}}>
                <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M11.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => {}}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
                  ...
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M14.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.props.navigation.navigate({routeName:'Scan',key:'Scan',params:{getEgg:this.getEgg}})}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
            ...
            <View style={styles.row1}>
              <View style={{flexDirection:'row',flexWrap:'nowrap',flex:1, width:'100%'}}>
                  ...
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M17.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.refs.score_modal.open()}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
            ...
            <View style={styles.row1}>
              <View style={{flexDirection:'row',flexWrap:'nowrap',flex:1, width:'100%'}}>
                  <ImageBackground
                    style={{width:height * 0.1125, height:height * 0.1125}}
                    source={require('../images/day3/2018/M21.png')}>
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.props.navigation.navigate({routeName:'Scan',key:'Scan',params:{getEgg:this.getEgg}})}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
                  ...
                  <ImageBackground
                    ...
                    <TouchableHighlight
                      underlayColor={'rgba(252,252,252,0.5)'} 
                      onPress={() => this.props.navigation.navigate({routeName:'RobotChat', key:'RobotChat'})}>
                      <View style={{width:'100%',height:height * 0.1125}}></View>
                    </TouchableHighlight>
                  </ImageBackground>
              </View>
